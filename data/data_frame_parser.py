...
class DataFrameParser(object):
    ...
    def __init__(
        self, preprocessor, labels=None, smiles_col="smiles", postprocess_label=None, postprocess_fn=None, logger=None
    ):
    ...
    def parse(self, df, return_smiles=False, target_index=None, return_is_successful=False):
        ...
        if isinstance(pp, GGNNPreprocessor):
            ...
            result = tuple(ret)
            logger.info(
                "Preprocess finished. FAIL {}, SUCCESS {}, TOTAL {}".format(fail_count, success_count, total_count)
            )
            print("Preprocess finished. FAIL {}, SUCCESS {}, TOTAL {}".format(fail_count, success_count, total_count))
        else:
